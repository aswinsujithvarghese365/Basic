...
Given a list of difficulty ratings for problems in the Chef’s to-do list, please help him identify how many of those 
problems Chef should remove from his to-do list, so that he is only left with problems of difficulty rating less than 1000.
...
The second line of input of each test case contains N space-separated integers D1, D2, D3,......, Dn, which are the difficulty ratings for each problem 
in the to-do list.
